...
- **Users:** Interactive check-in form with "Welcome to NEU Library!" personalized greeting.
- **Admins:** High-level dashboard with real-time statistics (Day, Week, Range).
- **Secure Switching:** Primary admins (`jcesperanza@neu.edu.ph` and `riccir.catimon@neu.edu.ph`) can switch between views on the fly.
