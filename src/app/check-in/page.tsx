  ...
  return (
    <div className="max-w-2xl mx-auto py-8">
      <div className="mb-8 space-y-2">
        ...
        <p className="text-muted-foreground">Welcome back, <span className="text-primary font-semibold">{user?.name}</span>. Please provide your visit details.</p>
      </div>
        ...
        <CardContent className="pt-6">
          <form onSubmit={handleCheckIn} className="space-y-6">
            <div className="space-y-2">
              ...
              <div className="p-3 bg-slate-50 border rounded-md text-slate-500 text-sm font-medium">
                {user?.email}
              </div>
            </div>
